...
namespace Nimble.Contact.Utils
{
    ...
    class UrlDefine
    {
        ...
        public const string VF_Refer = "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1";
        ...
        public const string Friend_List_Refer = "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1";
        public const string Group_List = "http://s.web2.qq.com/api/get_group_name_list_mask2";
        public const string Group_List_Refer = "http://d1.web2.qq.com/proxy.html?v=20151105001&callback=1&id=2";
        ...
        public const string Discuss_List_Refer = "http://d1.web2.qq.com/proxy.html?v=20151105001&callback=1&id=2";
        public const string Self_Info = "http://s.web2.qq.com/api/get_self_info2?t=#{t}";
        public const string Self_Info_Refer = "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1";
